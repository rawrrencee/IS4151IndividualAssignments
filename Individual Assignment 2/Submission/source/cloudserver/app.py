...
def deactivateLocalLD():
    ...
    if (districtToDeactivate == 1):
        url = 'http://192.168.1.23:5001/deactivateLocalLD'
    elif (districtToDeactivate == 2):
        url = 'http://192.168.1.178:5001/deactivateLocalLD'
...
def activateGlobalLD():
    ...
    url = 'http://192.168.1.23:5001/activateGlobalLD'
    r1 = requests.get(url)
    url = 'http://192.168.1.178:5001/activateGlobalLD'
    r2 = requests.get(url)
...
def deactivateGlobalLD():
    ...
    url = 'http://192.168.1.23:5001/deactivateGlobalLD'
    r1 = requests.get(url)
    url = 'http://192.168.1.178:5001/deactivateGlobalLD'
    r2 = requests.get(url)
